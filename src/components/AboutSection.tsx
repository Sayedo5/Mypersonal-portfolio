        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I&apos;m <span className="text-[#F3DBB3] font-medium">{profile.name}</span>, a full-stack
              web and mobile developer based in {profile.location}. {profile.bio}
            </motion.p>

            {/* Value propositions */}
            <motion.ul variants={fadeUpVariants} className="space-y-2.5 mb-10 max-w-xl">
              {[
                ...
                <li
                  key={line}
                  className="flex items-start gap-3 text-xs sm:text-[13px] font-light text-[#A8988B] leading-relaxed"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  <span className="text-[#D4AF37] mt-0.5 shrink-0" aria-hidden="true">
                    ✦
                  </span>
                  {line}
                </li>
            ...
            >
              {stats.map((stat) => (
                <div key={stat.label} className="flex flex-col">
                  ...
                  <dt className="text-[10px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5">
                    {stat.label}
                  </dt>
                </div>
              ))}
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            <motion.div
              ...
              className="relative p-3.5 border border-[#8C6D4F]/40 rounded-sm bg-[#120F0C]/80 backdrop-blur-xl shadow-[0_25px_70px_rgba(0,0,0,0.95)] group transition-colors duration-500 hover:border-[#D4AF37]/80"
            >
