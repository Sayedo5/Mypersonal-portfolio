    ...
    >
      ...
      <div className="max-w-4xl mx-auto w-full relative z-10">
        ...
        <div className="relative w-full">
          ...
          {/* Background Track */}
          <div className="absolute left-[19px] md:left-[160px] top-4 bottom-8 w-[1px] bg-[#8C6D4F]/20" />

          {/* Animated Gold Track */}
          <motion.div
            style={{ height: lineHeight }}
            className="absolute left-[19px] md:left-[160px] top-4 w-[2px] bg-gradient-to-b from-[#D4AF37] via-[#C99E5D] to-[#8C6D4F]/10 shadow-[0_0_10px_#D4AF37] origin-top"
          />
          ...
          <ol className="space-y-12">
            {journey.map((stop, idx) => (
              ...
              >
                ...
                <div className="hidden md:block w-[160px] shrink-0 pr-8 pt-0.5 text-right">
                ...
                {/* Route Node */}
                <div className="absolute left-[19px] md:left-[160px] top-1.5 -translate-x-1/2 flex items-center justify-center">
                  ...
                  <div
                    className={`w-2.5 h-2.5 rounded-full border transition-colors duration-300 ${
                      stop.current
                        ...
                        : 'bg-[#120F0C] border-[#8C6D4F] group-hover:bg-[#D4AF37] group-hover:border-[#D4AF37] group-hover:shadow-[0_0_12px_#D4AF37]'
                    }`}
                  />
                </div>
                ...
                <div className="ml-14 md:ml-12 pl-2">
                  ...
                  <div className="flex flex-wrap items-center gap-3 mb-1">
                    ...
                    {stop.current && (
                      <span
                        className="px-2 py-0.5 text-[9px] font-medium tracking-[0.18em] uppercase border border-[#D4AF37]/50 text-[#D4AF37] bg-[#D4AF37]/10"
                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                      >
                        CURRENT
                      </span>
